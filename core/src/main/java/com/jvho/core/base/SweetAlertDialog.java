...
public class SweetAlertDialog {
    ...
    private EditText mInputContentMessage;
    ...
    private void initView() {
        ...
        mInputContentMessage = rootView.findViewById(R.id.edt_dialog_message);
    ...
    private void updateDialogUI() {
        ...
        if (type == 0) {
            // normal dialog
            mInputContentMessage.setText("");
            mInputContentMessage.setVisibility(View.GONE);
            mContentMessage.setVisibility(View.VISIBLE);
        } else if (type == 1) {
            // input dialog
            mInputContentMessage.setVisibility(View.VISIBLE);
            ...
            mLeftTxt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mDialog != null)
                        mDialog.dismiss();
                    if (!hasCancle)
                        mNegativeButtonListener.onClick(mDialog, 0, null);
                }
            });
        }
        ...
        if (hasNull(mPositiveButtonText)) {
            ...
            mRightTxt.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (mDialog != null)
                        mDialog.dismiss();
                    mPositiveButtonListener.onClick(mDialog, 1, type == INPUT_TYPE ? getContent() : null);
                }
            });
        }
    }
    ...
    public String getContent() {
        return mInputContentMessage.getText().toString().trim();
    }
    ...
    public interface OnDialogClickListener {
        void onClick(Dialog dialog, int which, @Nullable String inputMsg);
    }
}
